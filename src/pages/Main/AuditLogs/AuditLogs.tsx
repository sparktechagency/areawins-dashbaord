          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap lg:flex-col gap-2 lg:gap-2">
              {["Create", "Delete", "Update", "Login"].map((type) => (
                <label
                  key={type}
                  className="flex items-center gap-2 cursor-pointer bg-slate-50 lg:bg-transparent px-3 py-1.5 lg:p-0 rounded-full lg:rounded-none"
                >
                  <input
                    type="checkbox"
