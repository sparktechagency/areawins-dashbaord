...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const baseStyles =
      "inline-flex items-center justify-center rounded-xl text-sm font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent disabled:pointer-events-none disabled:opacity-50 active:scale-95";
    const variants = {
      ...
      outline:
        "border border-slate-200 bg-white shadow-sm hover:bg-slate-50 hover:text-primary",
...
export const CardTitle = ({
  ...
  <h3
    className={`font-bold leading-none tracking-tight text-xl ${className}`}
    {...props}
  />
);
...
export const Badge = ({
  ...
  const variants = {
    ...
    success:
      "border-transparent bg-accent/10 text-accent border-accent/20 font-black",
  };
  return (
    <div
      className={`inline-flex items-center rounded-full border px-2.5 py-0.5 text-[10px] uppercase font-bold tracking-wider transition-colors focus:outline-none ${variants[variant]} ${className}`}
      {...props}
    />
  );
};
...
export const TableHeader = ({
  ...
  <thead
    className={`[&_tr]:border-b border-slate-100 ${className}`}
    {...props}
  />
);
...
export const TableRow = ({
  ...
  <tr
    className={`border-b border-slate-50 transition-colors hover:bg-slate-50/50 ${className}`}
    {...props}
  />
);
...
export const TableHead = ({
  ...
  <th
    className={`h-12 px-4 text-left align-middle font-bold text-slate-400 uppercase text-[10px] tracking-widest ${className}`}
    {...props}
  />
);
